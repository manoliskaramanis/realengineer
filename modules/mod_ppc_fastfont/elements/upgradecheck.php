<?php 
/*
* Pixel Point Creative - Fast Font Module
...
class JFormFieldUpgradecheck extends JFormField {
	...
	protected function getLabel()
	{
		...
		//If cURL is supported, check the current version available.
				...
				$version = 1.1;
				$target = 'http://www.pixelpointcreative.com/upgradecheck/fastfont/index.txt';
				$curl = curl_init();
				...
				if ($version < $str)
					...
					<a href="index.php?option=com_installer&view=update" >Update</a>&nbsp;&nbsp;|&nbsp; &nbsp;<a href="http://www.pixelpointcreative.com/support.html" target="_blank">Get Help</a> &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.pixelpointcreative.com/changelogs/fastfont.txt" target="_blank">View the Changelog</a></label></div>';
				...
				echo'<div><img width="180" height="80" border="0" src="../modules/mod_ppc_fastfont/elements/logo.png" title="Fast Font" alt="Fast Font"></div>';  
				return 
				$message;
